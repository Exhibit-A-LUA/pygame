...
class Shell(pygame.sprite.Sprite):
  ...
  def state_management(self):
    ...
    # alternative suggested by @tasteDaRDX
    # I checked it ad it works
    # comment out above 4 lines and the below if statement and replace with the following:

    # front_rect = pygame.Rect(self.rect.center, (500*self.bullet_direction, 2))
