...
class Spike(Sprite):
  def __init__(self, pos, surf, groups, radius, speed, start_angle, end_angle, z = Z_LAYERS['main']):
    ...
    # code suggested by same guy:
    # comment out the x, y, and super()._init lines below and uncomment the two lines here
  ...
  def update(self, dt):
    ...
    # rotation using a vector
    # code suggested by same guy:
    # comment out the x, y, and self.rect.center lines below and uncomment the two lines here
