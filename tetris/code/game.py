...
class Game:
  def __init__(self, get_next_shape, update_score):
    ...
    self.display_surface = pygame.display.get_surface() # returns the main surface of the app
  ...
  def input(self):
    # can use get_just_pressed instead of using timers
  ...
  def rotate(self):
    if self.shape != 'O':
      ...
      for pos in new_block_positions:
        ...
        # filed check -> collision with other pieces
